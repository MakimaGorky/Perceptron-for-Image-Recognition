...
namespace NeuralNetwork1
{
    ...
    public class Sample
    {
        ...
        /// <summary>
        /// Вычисляет квадратичную ошибку между ожидаемым выходом (Target) и выходом сети, НО!
        /// Не изменяет внутреннее состояние Sample, потому что вычисление происходит без учета error,
        /// потому что когда он заполняется, в ProcessPrediction, портится Output
        /// Извините Максим Валентинович, я испорчу эту архитектуру
        /// </summary>
